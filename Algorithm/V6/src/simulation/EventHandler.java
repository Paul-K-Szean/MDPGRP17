...
public class EventHandler implements IHandler {
    ...
    private static String waypointRpi = "";
    ...
    private void _shortestPathProcedure(int exePeriod, String sPwaypoint) throws IOException {
        ...
        LinkedList<RobotMovement> actions = RobotMovement.fromPath(gui.getRobot(), normalSolve);
        //System.out.println(normalSolve);
        ...
        if (!Main.isSimulating()) {
            ...
            Main.getRpi().sendShortestPathMoveCommand(actions, MessageTranslator.MODE_1);
